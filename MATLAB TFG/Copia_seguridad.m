...
% hrtf2 = SOFAload('H3_44K_16bit_256tap_FIR_SOFA.sofa');
...
%[ITDt1, ITDww1, TdiffITD1, bestUmbral1] = Function_MetodoUmbralYGraficas(hrtf1,'D1_44K_16bit_256tap_FIR_SOFA');
...
% [ITDt2, ITDww2, TdiffITD2, bestUmbral2,hrtf2] = Function_MetodoUmbralYGraficas(hrtf2,'H3_44K_16bit_256tap_FIR_SOFA');
% %porcAciertos2 = CalculoOutlayers(ITDt2,ITDww2(:,3));
% [ITDt3, ITDww3, TdiffITD3, bestUmbral3] = Function_MetodoUmbralYGraficas(hrtf3,'H5_48K_24bit_256tap_FIR_SOFA');
% % porcAciertos3 = CalculoOutlayers(ITDt3,ITDww3(:,3));
% [ITDt4, ITDww4, TdiffITD4, bestUmbral4] = Function_MetodoUmbralYGraficas(hrtf4,'H7_96K_24bit_512tap_FIR_SOFA');
% % porcAciertos4 = CalculoOutlayers(ITDt4,ITDww4(:,3));
% [ITDt5, ITDww5, TdiffITD5, bestUmbral5] = Function_MetodoUmbralYGraficas(hrtf5,'H9_44K_16bit_256tap_FIR_SOFA');
% % porcAciertos5 = CalculoOutlayers(ITDt5,ITDww5(:,3));
% [ITDt6, ITDww6, TdiffITD6, bestUmbral6] = Function_MetodoUmbralYGraficas(hrtf6,'H11_44K_16bit_256tap_FIR_SOFA');
% % porcAciertos6 = CalculoOutlayers(ITDt6,ITDww6(:,3));
% [ITDt7, ITDww7, TdiffITD7, bestUmbral7] = Function_MetodoUmbralYGraficas(hrtf7,'H13_44K_16bit_256tap_FIR_SOFA');
% % porcAciertos7 = CalculoOutlayers(ITDt7,ITDww7(:,3));
% [ITDt8, ITDww8, TdiffITD8, bestUmbral8] = Function_MetodoUmbralYGraficas(hrtf8,'H15_44K_16bit_256tap_FIR_SOFA');
% % porcAciertos8 = CalculoOutlayers(ITDt8,ITDww8(:,3));
% [ITDt9, ITDww9, TdiffITD9, bestUmbral9] = Function_MetodoUmbralYGraficas(hrtf9,'H17_44K_16bit_256tap_FIR_SOFA');
% % porcAciertos9 = CalculoOutlayers(ITDt9,ITDww9(:,3));
% [ITDt10, ITDw10, TdiffITD10, bestUmbral10] = Function_MetodoUmbralYGraficas(hrtf10,'H19_44K_16bit_256tap_FIR_SOFA');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [ITDt1, ITDww1, TdiffITD1, bestUmbral1] = Function_MetodoUmbralYGraficas(hrtf1,'ARI_NH2_hrtf_M_dtf 256');
% [ITDt2, ITDww2, TdiffITD2, bestUmbral2] = Function_MetodoUmbralYGraficas(hrtf2,'ARI_NH8_hrtf_M_dtf 256');
% [ITDt3, ITDww3, TdiffITD3, bestUmbral3] = Function_MetodoUmbralYGraficas(hrtf3,'ARI_NH10_hrtf_M_dtf 256');
% [ITDt4, ITDww4, TdiffITD4, bestUmbral4] = Function_MetodoUmbralYGraficas(hrtf4,'ARI_NH12_hrtf_M_dtf 256');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [ITDt1, ITDww1, TdiffITD1, bestUmbral1] = Function_MetodoUmbralYGraficas(hrtf1,'CIPIC_subject_003_hrir_final');
% [ITDt2, ITDww2, TdiffITD2, bestUmbral2] = Function_MetodoUmbralYGraficas(hrtf2,'CIPIC_subject_009_hrir_final');
% [ITDt3, ITDww3, TdiffITD3, bestUmbral3] = Function_MetodoUmbralYGraficas(hrtf3,'CIPIC_subject_012_hrir_final');
% [ITDt4, ITDww4, TdiffITD4, bestUmbral4] = Function_MetodoUmbralYGraficas(hrtf4,'CIPIC_subject_015_hrir_final');
